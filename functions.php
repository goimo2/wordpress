...
function bulmawp_enqueue()
{
    ...
    wp_enqueue_style('neobridge_css', get_template_directory_uri() . '/assets/css/index2.css');
...
function bulmawp_register_menus()
{
    ...
    register_nav_menu('navbar_footer', 'Navbar footer');
}
...
function themeperso_register_menus()
{
...
add_action('init', 'themeperso_register_menus');
